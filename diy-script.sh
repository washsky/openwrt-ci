...
# 添加额外插件
git clone --depth=1 -b main https://github.com/VIKINGYFY/luci-app-wolplus package/luci-app-wolplus
...
git clone --depth=1 -b js https://github.com/SAENE/luci-theme-design  package/luci-theme-design
